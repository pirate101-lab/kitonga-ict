...
export default function DashboardPage() {
 ...
 {/* Search */}
 <label htmlFor="order-search" className="mt-6 flex items-center gap-3 rounded-xl border border-primary/25 bg-card px-4 py-2.5 text-sm text-foreground ">
 ...
 : "border-[hsl(var(--warning,38_92%_50%)/0.4)] bg-[hsl(var(--warning,38_92%_50%)/0.12)] text-[hsl(var(--warning,38_92%_50%))]"
 }`}
 >
 {o.status}
 </span>
