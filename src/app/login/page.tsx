  ...
  return (
    <div className="min-h-[calc(100vh-56px)] bg-[#f2f5f9] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        {/* Card */}
        <div className="bg-white rounded-2xl border border-[#9ca3af] p-6">
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border-[1.5px] border-[#9ca3af] bg-white px-3.5 py-3 text-[14px] text-[#0a0a0a] outline-none transition-colors placeholder:text-[#888] focus:border-[#0067b8] focus:ring-2 focus:ring-[#0067b8]/20"
              />
            </div>
