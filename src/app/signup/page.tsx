          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#9ca3af] bg-white px-3.5 py-3 text-[14px] text-[#0a0a0a] outline-none transition-colors placeholder:text-[#888] focus:border-[#0067b8] focus:ring-2 focus:ring-[#0067b8]/20"
              />
            </div>
