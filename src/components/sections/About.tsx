        ...
        <Reveal>
          <div className="mb-10 max-w-xl">
            ...
            <div className="flex flex-wrap gap-2.5 mt-5">
              <Link
                href="/portfolio"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border-2 border-black bg-white text-[13px] font-semibold text-[#111] hover:border-[#0067b8] hover:text-[#0067b8] transition-colors"
              >
                View our work
