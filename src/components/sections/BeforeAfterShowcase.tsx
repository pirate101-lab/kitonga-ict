...
export function BeforeAfterShowcase() {
 ...
 <Reveal>
 <div className="mb-6">
 <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#0067b8] mb-2">Before · After</p>
 ...
 <div>
 <div className="text-[#444] text-[10.5px] font-medium uppercase tracking-[0.12em] mb-0.5">Turnaround</div>
 <div className="text-[13px] font-semibold text-[#0a0a0a]">12 – 24 hrs</div>
 </div>
 <div>
 <div className="text-[#444] text-[10.5px] font-medium uppercase tracking-[0.12em] mb-0.5">Output</div>
 <div className="text-[13px] font-semibold text-[#0a0a0a]">PSD · PDF · PNG</div>
 </div>
 </div>
 </div>
 </div>
