...
export function FAQ() {
 ...
 return (
 <section className="relative py-12 md:py-16 bg-white border-t border-[#9ca3af]" id="faq">
 <div className="container-narrow">
 <Reveal>
 <div className="mb-8">
 <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#0067b8] mb-2">FAQ</p>
 <h2 className="text-2xl sm:text-3xl font-bold text-[#0a0a0a] tracking-tight">Answers, before you ask.</h2>
 </div>
 </Reveal>

 <Reveal y={12}>
 <div className="mx-auto max-w-3xl divide-y divide-[#cbd5e1]">
 {FAQS.map((item, i) => {
 const isOpen = open === i;
