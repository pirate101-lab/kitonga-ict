  ...
  return (
    <section className="bg-[#f2f5f9]">
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 py-10 md:py-16 lg:py-20 lg:items-center">

          {/* Left: text */}
          <div className="pb-6 lg:pb-0">
            <h1 className="text-[3.15rem] leading-[1.05] font-bold text-[#0a0a0a] tracking-tight mb-5">
              Design work<br />
