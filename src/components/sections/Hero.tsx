        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 py-14 md:py-20 lg:items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2.5">
              ...
              <Link
                href="/services"
                className="inline-flex items-center justify-center px-5 py-3 rounded-lg border-2 border-black bg-white text-[14px] font-medium text-[#111] hover:border-[#0067b8] hover:text-[#0067b8] transition-colors w-full sm:w-auto"
              >
                See all services
              </Link>
            </div>
          ...
          <div className="hidden lg:block relative w-full aspect-[4/3] rounded-2xl overflow-hidden border-2 border-black">
            <Image
