...
export function Process() {
  return (
    <section className="py-12 md:py-16 bg-white border-t border-black/30" id="process">
      <div className="container-narrow">
        ...
        <Reveal y={10} delay={80}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 divide-y sm:divide-y-0 divide-[#cbd5e1] border-2 border-black/30 rounded-2xl overflow-hidden">
            {STEPS.map((step) => (
              <div key={step.n} className="flex flex-col gap-2 p-5 bg-white hover:bg-[#f7f9fc] transition-colors">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[10.5px] font-medium text-[#444] border-2 border-black/30 rounded-full px-2 py-0.5">
                    {step.duration}
                  </span>
                </div>
