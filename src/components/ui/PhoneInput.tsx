...
export function PhoneInput({
  ...
  return (
    <div
      className={cn(
        "flex items-stretch rounded-xl border-[1.5px] border-black/30 bg-white transition-colors focus-within:border-[#0067b8] focus-within:ring-2 focus-within:ring-[#0067b8]/20",
    ...
    >
      ...
      <span
        className={cn(
          "select-none flex items-center px-3 text-sm font-semibold text-[#555] border-r border-black/30 bg-[#f5f5f5] rounded-l-xl",
          padY,
        )}
        aria-hidden
      >
